...
while.body:                                       ; preds = %while.cond.preheader, %for.end115
  ...
  br i1 %cmp31247, label %for.body33, label %for.end115

for.body33:                                       ; preds = %while.body, %for.inc113
  %conv30249 = phi i32 [ %conv30, %for.inc113 ], [ 0, %while.body ]
  %m.1248 = phi i16 [ %inc114, %for.inc113 ], [ 0, %while.body ]
...
for.body61:                                       ; preds = %for.body61.lr.ph, %for.body61
  ...
  %call = tail call i32 bitcast (i32 (...)* @please_map_me to i32 ()*)() #7
  ...
  br i1 %cmp59, label %for.body61, label %for.inc113

for.inc113:                                       ; preds = %for.body61, %for.body33
  %inc114 = add i16 %m.1248, 1
  %conv30 = sext i16 %inc114 to i32
  %cmp31 = icmp sgt i32 %l.1250, %conv30
  br i1 %cmp31, label %for.body33, label %for.end115

for.end115:                                       ; preds = %for.inc113, %while.body
...
while.body:                                       ; preds = %while.cond.preheader, %for.end148
  ...
  br i1 %tobool, label %for.body30, label %if.end61
...
for.body30:                                       ; preds = %while.body, %for.cond27
  %i.0297 = phi i32 [ %inc55, %for.cond27 ], [ 0, %while.body ]
...
for.end56:                                        ; preds = %for.cond27, %for.body30
...
for.body67:                                       ; preds = %for.body67.lr.ph, %for.inc146
...
for.body95:                                       ; preds = %for.body95.lr.ph, %for.body95
  ...
  br i1 %cmp93, label %for.body95, label %for.inc146

for.inc146:                                       ; preds = %for.body95, %for.body67
  %inc147 = add i16 %m.2301, 1
  %conv64 = sext i16 %inc147 to i32
  %cmp65 = icmp sgt i32 %l.1303, %conv64
  br i1 %cmp65, label %for.body67, label %for.end148

for.end148:                                       ; preds = %for.inc146, %if.end61
...
; Function Attrs: nounwind
define dso_local i32 @fix_fftr(i16* nocapture %f, i32 %m, i32 %inverse) local_unnamed_addr #0 {
entry:
  %sub = add nsw i32 %m, -1
...
define dso_local void @filter(i32 %startF, i32 %endF, i16* nocapture %real, i16* nocapture %imag, i32 %N) local_unnamed_addr #4 {
entry:
  %div = sdiv i32 %N, 2
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 256, i8* nonnull %1) #7
  call void @llvm.lifetime.start.p0i8(i64 256, i8* nonnull %0) #7
...
for.body4.for.body4_crit_edge:                    ; preds = %for.end, %for.body4.for.body4_crit_edge
...
for.end11:                                        ; preds = %for.body4.for.body4_crit_edge
  %arraydecay = getelementptr inbounds [128 x i16], [128 x i16]* %real, i32 0, i32 0
  %arraydecay12 = getelementptr inbounds [128 x i16], [128 x i16]* %imag, i32 0, i32 0
  %call13 = call i32 @fix_fft_128(i16* nonnull %arraydecay, i16* nonnull %arraydecay12, i16 signext 0)
...
for.body18:                                       ; preds = %for.body18, %for.end11
  ...
  br i1 %exitcond74, label %for.body.i, label %for.body18

for.body.i:                                       ; preds = %for.body18, %if.end13.i
  %i.034.i = phi i32 [ %inc.i, %if.end13.i ], [ 0, %for.body18 ]
...
if.then10.i:                                      ; preds = %if.end.i.thread, %if.end.i
...
if.end13.i:                                       ; preds = %if.end.i, %if.then10.i
...
filter.exit:                                      ; preds = %if.end13.i
  %call31 = call i32 @fix_fft_128(i16* nonnull %arraydecay, i16* nonnull %arraydecay12, i16 signext 1)
...
for.end44:                                        ; preds = %for.body36
  %call47 = call i32 @fix_fft(i16* nonnull %arraydecay, i16* nonnull %arraydecay12, i16 signext undef, i16 signext 0)
  call void @llvm.lifetime.end.p0i8(i64 256, i8* nonnull %0) #7
  call void @llvm.lifetime.end.p0i8(i64 256, i8* nonnull %1) #7
  ret i32 0
}
...
attributes #3 = { nofree norecurse nounwind "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="none" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="pentium4" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #4 = { nofree norecurse nounwind writeonly "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="none" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="pentium4" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #5 = { nofree nounwind "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="none" "less-precise-fpmad"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="pentium4" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
