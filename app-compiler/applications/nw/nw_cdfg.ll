...
for.body:                                         ; preds = %for.body, %entry
  ...
  br i1 %exitcond225, label %for.body8.preheader, label %for.body

for.body8.preheader:                              ; preds = %for.body
  br label %for.body8

for.body8:                                        ; preds = %for.body8.preheader, %for.body8
  %b_idx.0219 = phi i32 [ %inc13, %for.body8 ], [ 0, %for.body8.preheader ]
  ...
  br i1 %exitcond224, label %for.cond18.preheader.preheader, label %for.body8

for.cond18.preheader.preheader:                   ; preds = %for.body8
  br label %for.cond18.preheader

for.cond18.preheader:                             ; preds = %for.cond18.preheader.preheader, %for.inc75
  %b_idx.1218 = phi i32 [ %inc76, %for.inc75 ], [ 1, %for.cond18.preheader.preheader ]
...
for.inc72:                                        ; preds = %if.else67, %if.then64, %if.then58
...
for.inc75:                                        ; preds = %for.inc72
  ...
  br i1 %exitcond223, label %while.body.preheader, label %for.cond18.preheader

while.body.preheader:                             ; preds = %for.inc75
  br label %while.body

for.cond122.preheader:                            ; preds = %if.end121
  %b_str_idx.1.lcssa = phi i32 [ %b_str_idx.1, %if.end121 ]
  %b_str_idx.0216.lcssa = phi i32 [ %b_str_idx.0216, %if.end121 ]
  %cmp123211 = icmp ult i32 %b_str_idx.0216.lcssa, 255
  br i1 %cmp123211, label %for.body133.preheader, label %for.end137

while.body:                                       ; preds = %while.body.preheader, %if.end121
  %b_str_idx.0216 = phi i32 [ %b_str_idx.1, %if.end121 ], [ 0, %while.body.preheader ]
  %b_idx.2214 = phi i32 [ %b_idx.3, %if.end121 ], [ 128, %while.body.preheader ]
  %a_idx.2213 = phi i32 [ %a_idx.3, %if.end121 ], [ 128, %while.body.preheader ]
...
if.end121:                                        ; preds = %if.else112, %if.then104, %if.then88
...
for.body133.preheader:                            ; preds = %for.cond122.preheader
  %scevgep221 = getelementptr [256 x i8], [256 x i8]* @alignedA, i32 0, i32 %b_str_idx.1.lcssa
  %17 = sub nuw nsw i32 255, %b_str_idx.0216.lcssa
  call void @llvm.memset.p0i8.i32(i8* align 1 %scevgep221, i8 95, i32 %17, i1 false)
  %scevgep = getelementptr [256 x i8], [256 x i8]* @alignedB, i32 0, i32 %b_str_idx.1.lcssa
  call void @llvm.memset.p0i8.i32(i8* align 1 %scevgep, i8 95, i32 %17, i1 false)
  br label %for.end137

for.end137:                                       ; preds = %for.body133.preheader, %for.cond122.preheader
  ret void
}
