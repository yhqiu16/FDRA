...
for.body:                                         ; preds = %for.body, %entry
  ...
  br i1 %exitcond24, label %for.body.i.preheader, label %for.body

for.body.i.preheader:                             ; preds = %for.body
  br label %for.body.i

for.body.i:                                       ; preds = %for.body.i.preheader, %for.body.i
  %i.010.i = phi i32 [ %add.i, %for.body.i ], [ 0, %for.body.i.preheader ]
  ...
  br i1 %exitcond.i, label %for.body7.preheader, label %for.body.i

for.body7.preheader:                              ; preds = %for.body.i
  br label %for.body7

for.body7:                                        ; preds = %for.body7.preheader, %for.body7
  %i.122 = phi i32 [ %inc10, %for.body7 ], [ 0, %for.body7.preheader ]
