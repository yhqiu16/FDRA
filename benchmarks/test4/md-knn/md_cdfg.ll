...
for.end:                                          ; preds = %for.body11
  %add30.lcssa = phi i32 [ %add30, %for.body11 ]
  %add32.lcssa = phi i32 [ %add32, %for.body11 ]
  %add34.lcssa = phi i32 [ %add34, %for.body11 ]
  %arrayidx35 = getelementptr inbounds [64 x i32], [64 x i32]* @force_x, i32 0, i32 %i.091
  store i32 %add30.lcssa, i32* %arrayidx35, align 4, !tbaa !3
  %arrayidx36 = getelementptr inbounds [64 x i32], [64 x i32]* @force_y, i32 0, i32 %i.091
  store i32 %add32.lcssa, i32* %arrayidx36, align 4, !tbaa !3
  %arrayidx37 = getelementptr inbounds [64 x i32], [64 x i32]* @force_z, i32 0, i32 %i.091
  store i32 %add34.lcssa, i32* %arrayidx37, align 4, !tbaa !3
